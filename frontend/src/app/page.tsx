          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div className="text-center animate-fade-in">
              ...
              <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto">
                ...
                and multi-language code execution. Join thousands of developers improving their skills.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white/5 backdrop-blur-lg border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-all transform hover:scale-105 animate-slide-up">
              ...
              <p className="text-gray-400 leading-relaxed">
                Solve hundreds of coding problems across various difficulty levels, from beginner to advanced.
              </p>
            </div>

            <div className="bg-white/5 backdrop-blur-lg border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-all transform hover:scale-105 animate-slide-up" style={{animationDelay: '0.1s'}}>
            ...
            <div className="bg-white/5 backdrop-blur-lg border border-white/10 p-8 rounded-2xl hover:bg-white/10 transition-all transform hover:scale-105 animate-slide-up" style={{animationDelay: '0.2s'}}>
              ...
              <p className="text-gray-400 leading-relaxed">
                Monitor your performance with detailed analytics and watch your skills improve over time.
              </p>
            </div>
          </div>
        </div>
