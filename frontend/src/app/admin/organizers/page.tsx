...
function AdminOrganizersContent() {
  ...
  const [roleFilter, setRoleFilter] = useState('CONTEST_MANAGER');
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage external organizers and their contest access</p>
            </div>
            <button
      ...
      {showEditDialog && selectedUser && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-dark-card rounded-2xl shadow-xl p-6 max-w-md w-full">
            <div className="flex items-center justify-between mb-5">
              <h3 className="text-lg font-bold text-gray-900 dark:text-white">Edit Organizer</h3>
              <button
                onClick={() => {
                  setShowEditDialog(false);
                  setSelectedUser(null);
