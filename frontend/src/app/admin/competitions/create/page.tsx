...
function CreateContestContent() {
  ...
  const handleProblemCreated = async (newProblemId: string) => {
    // Refresh the problems list so the new problem is available in the UI
    await fetchProblems();
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="mt-8">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Select Problems</h3>
                    <button
                      type="button"
